...
- If you select an acceptable study and you are the first to "claim" it, it's yours. Once a study is claimed, Dr. Love will post it to [the OSIA claims page](https://github.com/THOMASELOVE/500-classes-2026/tree/main/osia). If you select a study that someone else has beaten you to, you will have to submit an alternative.
