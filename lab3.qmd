...
I haven't provided a template for this Lab, but note that my sketch for Lab 3 starts by repeating everything from [Lab 2](lab2.qmd), and you may want to take a similar approach.

## Data

Lab 3 again uses the `canc3.csv` data file we used in [Lab 2](lab2.qmd). The data remain available on the [500-data web page](https://github.com/THOMASELOVE/500-data).
